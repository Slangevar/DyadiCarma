...
#' @param rnd string, if it is one the strings 'binom', 'unif', 'norm' it indicate 
...
#' @param par vector of two numeric values, these are parameters for the distributions used to generate
#' the entries.
